...
const widgetConfig = {
  ...
  agentId:
    ...
    "agent_ce01bdc30264329416220de0f7",
  transferAgentId:
    scriptTag?.getAttribute("data-transfer-agent-id") ||
    "agent_ce01bdc30264329416220de0f7",
  ...
  oldAgentID:
    ...
    "agent_ce01bdc30264329416220de0f7",
  transferAgentName:
    scriptTag?.getAttribute("data-transfer-agent-name") || "Noah",
  apiKey: "key_35cff8f30bf8bb98d31b4f11a199",
  textOne: "Speak With",
